                      ...
                      <tr key={users.id}>
                        <td class="p-2">
                          <div class="flex items-center gap-3">
                            <img src={users.profile_picture} alt={`${users.first_name}'s profile`} class="inline-block relative object-center !rounded-full w-12 h-12 rounded-lg border border-blue-gray-50 bg-blue-gray-50/50 object-contain p-1" />
