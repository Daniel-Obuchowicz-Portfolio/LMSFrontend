            ...
            <div className="bg-white dark:bg-primary p-4 rounded-lg shadow-md">
              {isLoading ? (
                ...
                <div className='flex justify-between items-center gap-5'>
                  ...
                  <div className='w-[85%]'>
                    <h2 className="text-xl font-semibold dark:text-white">Łączna ilość czytelników</h2>
            ...
            <div className="bg-white dark:bg-primary p-4 rounded-lg shadow-md h-auto">
              {isLoading ? (
                ...
                <div className='flex justify-between items-center gap-5'>
                  ...
                  <div className='w-[85%]'>
                    <h2 className="text-xl font-semibold dark:text-white">Łączna ilość księgozbioru</h2>
            ...
            <div className="bg-white dark:bg-primary p-4 rounded-lg shadow-md">
              {isLoading ? (
                ...
                <div className='flex justify-between items-center gap-5'>
                  ...
                  <div className='w-[85%]'>
                    <h2 className="text-xl font-semibold dark:text-white">Łączna ilość wypożyczeń</h2>
                    <p className="text-2xl mt-2 dark:text-gray-300">{bookCount}</p>
                  </div>
                </div>
              )}
